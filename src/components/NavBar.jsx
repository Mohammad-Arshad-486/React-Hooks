  ...
  return (
    <div className="background-color-gray-500">
      <p className="fixed top-0 left-0 p-5 border-blue-100 outline-blue">
        ...
        <Link to="/" className="text-white ml-4 p-5">
          Home
        </Link>
        <Link to="/counter" className="text-white ml-4">
          Counter
        </Link>
        <Link to="/weather" className="text-white ml-4">
          Weather App
        </Link>
        <Link to="/stopwatch" className="text-white ml-4">
          Stop Watch
        </Link>
      </p>
    </div>
